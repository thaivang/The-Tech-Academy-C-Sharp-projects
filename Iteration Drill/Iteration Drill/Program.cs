...
namespace Iteration_Drill
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //Create new list above to contain duplicate values. Foreach loop will iterate through each item. First item is "crunch" which will 
            //check storage list. If item is not in storage list, it will add that item to the storage list executing the else statement.
            //foreach loop will iterate again, executing the if statement because the duplicated item "crunch" is present in the "storage list". 
            //thus Printing it is already in the list.
            //"hello" is unique item which won't print to the console as there is only one item.
